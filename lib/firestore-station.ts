// lib/firestore-station.ts - FIXED: Removed composite index requirements
import { 
  collection, 
  doc, 
  addDoc, 
...
// Mission Attempt functions - FIXED: Removed composite index requirement
...
export const getMissionCompletionStatus = async (
  ...
  return {
    ...
    lastAttempt: attempts[0] // Most recent attempt (already sorted)
  };
};